    ...
    >
      ...
      >
        ...
        <g mask="url(#db-mask-1)">
          <circle className="database db-light-1" cx="0" cy="0" r="12" fill="url(#db-blue-grad)" filter="url(#db-glow)">
        ...
        <g mask="url(#db-mask-2)">
          <circle className="database db-light-2" cx="0" cy="0" r="12" fill="url(#db-blue-grad)" filter="url(#db-glow)">
            <animate attributeName="r" values="10;12;10" dur="3s" repeatCount="indefinite" />
        ...
        <g mask="url(#db-mask-3)">
          <circle className="database db-light-3" cx="0" cy="0" r="12" fill="url(#db-blue-grad)" filter="url(#db-glow)">
            <animate attributeName="r" values="10;12;10" dur="3s" repeatCount="indefinite" />
        ...
        <g mask="url(#db-mask-4)">
          <circle className="database db-light-4" cx="0" cy="0" r="12" fill="url(#db-blue-grad)" filter="url(#db-glow)">
            <animate attributeName="r" values="10;12;10" dur="3s" repeatCount="indefinite" />
